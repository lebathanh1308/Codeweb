    ...
    class cart
    {
        ...
        public function update_quantity_cart($quantity, $cartId) {
            ...
            if($result) {
                ...
                $msg = "<span class='error' style='color:red;'>Số lượng sản phẩm cập nhật không thành công</span>";
                return $msg;
            }
        }
        ...
        public function shifted($id,$time,$price) {
            ...
            $result = $this->db->update($query);
            if($result) {
                $msg = "<span class='success' style='color:green;'>Cập nhật đơn hàng thành công</span>";
                return $msg;
            } else {
                $msg = "<span class='error' style='color:red;'>Cập nhật đơn hàng không thành công</span>";
                return $msg;
            }
        }
        public function del_shifted($id,$time,$price) {
            ...
            $result = $this->db->update($query);
            if($result) {
                $msg = "<span class='success' style='color:green;'>Xóa đơn hàng thành công</span>";
                return $msg;
            } else {
                $msg = "<span class='error' style='color:red;'>Xóa đơn hàng không thành công</span>";
                return $msg;
            }
        }
